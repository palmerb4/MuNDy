...
#ifndef MUNDY_AGENT_RANKEDASSEMBLY_HPP_
#define MUNDY_AGENT_RANKEDASSEMBLY_HPP_
...
template <mundy::core::StringLiteral name, stk::topology::rank_t rank,
...
#endif  // MUNDY_AGENT_RANKEDASSEMBLY_HPP_
