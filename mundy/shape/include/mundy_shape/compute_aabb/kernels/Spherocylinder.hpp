...
#ifndef MUNDY_SHAPE_COMPUTE_AABB_KERNELS_SPHEROCYLINDER_HPP_
#define MUNDY_SHAPE_COMPUTE_AABB_KERNELS_SPHEROCYLINDER_HPP_
...
class Spherocylinder : public mundy::meta::MetaKernel<void> {
 public:
  ...
  static std::shared_ptr<mundy::meta::MeshRequirements> get_mesh_requirements(
    ...
    for (int i = 0; i < num_parts; i++) {
      ...
      if (part_name == "SPHEROCYLINDERS") {
        ...
        // Add the associated part as a subset of the spherocylinders part.
        const std::string parent_part_name = "SPHEROCYLINDERS";
  ...
  static void validate_mutable_parameters_and_set_defaults(
    ...
    mundy::meta::check_parameter_and_set_default(
        mutable_params_ptr,
        ParamConfig<double>{.name = "buffer_distance",
...
#endif  // MUNDY_SHAPE_COMPUTE_AABB_KERNELS_SPHEROCYLINDER_HPP_
