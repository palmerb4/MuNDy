...
FENESpringsKernel::FENESpringsKernel(mundy::mesh::BulkData *const bulk_data_ptr,
  ...
  const std::string node_coord_field_name = FENESprings::get_node_coord_field_name();
  const std::string element_rmax_field_name = FENESprings::get_element_rmax_field_name();
  const std::string element_spring_constant_field_name = FENESprings::get_element_spring_constant_field_name();
...
std::vector<stk::mesh::Part *> FENESpringsKernel::get_valid_entity_parts() const {
  return valid_entity_parts_;
}

void FENESpringsKernel::set_mutable_params(const Teuchos::ParameterList &mutable_params) {
  Teuchos::ParameterList valid_mutable_params = mutable_params;
  valid_mutable_params.validateParametersAndSetDefaults(FENESpringsKernel::get_valid_mutable_params());
}
//}
...
void FENESpringsKernel::execute(const stk::mesh::Selector &spring_selector) {
