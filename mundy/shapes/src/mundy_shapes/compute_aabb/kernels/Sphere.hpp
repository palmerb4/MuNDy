...
#ifndef MUNDY_SHAPES_COMPUTE_AABB_KERNELS_SPHERE_HPP_
#define MUNDY_SHAPES_COMPUTE_AABB_KERNELS_SPHERE_HPP_
  ...
  static Teuchos::ParameterList get_valid_fixed_params() {
    static Teuchos::ParameterList default_parameter_list =
        Teuchos::ParameterList()
            .set("valid_entity_part_names", mundy::core::make_string_array(mundy::shapes::Spheres::get_name()),
...
#endif  // MUNDY_SHAPES_COMPUTE_AABB_KERNELS_SPHERE_HPP_
