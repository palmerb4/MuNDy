...
#ifndef MUNDY_SHAPES_COMPUTE_BOUNDING_RADIUS_KERNELS_SPHEROCYLINDERSEGMENT_HPP_
#define MUNDY_SHAPES_COMPUTE_BOUNDING_RADIUS_KERNELS_SPHEROCYLINDERSEGMENT_HPP_

/// \file SpherocylinderSegment.hpp
/// \brief Declaration of the ComputeBOUNDING_RADIUS's SpherocylinderSegment kernel.
...
/// \brief Concrete implementation of \c MetaKernel for computing the bounding radius of SpherocylinderSegments.
class SpherocylinderSegment : public mundy::meta::MetaKernel<> {
 public:
  ...
  static Teuchos::ParameterList get_valid_fixed_params() {
    ...
    default_parameter_list.set("element_bounding_radius_field_name", std::string(default_element_bounding_radius_field_name_),
...
#endif  // MUNDY_SHAPES_COMPUTE_BOUNDING_RADIUS_KERNELS_SPHEROCYLINDERSEGMENT_HPP_
