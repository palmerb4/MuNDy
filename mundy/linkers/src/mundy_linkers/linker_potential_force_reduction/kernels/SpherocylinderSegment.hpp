...
#ifndef MUNDY_LINKERS_LINKER_POTENTIAL_FORCE_REDUCTION_SPHEROCYLINDER_SEGMENT_HPP_
#define MUNDY_LINKERS_LINKER_POTENTIAL_FORCE_REDUCTION_SPHEROCYLINDER_SEGMENT_HPP_

/// \file SpherocylinderSegment.hpp
/// \brief Declaration of the LinkerPotentialForceReduction's SpherocylinderSegment kernel.
...
/// \brief Concrete implementation of \c MetaKernel for reducing potential forces generated by linkers.
/// SpherocylinderSegment specialization.
    ...
    static Teuchos::ParameterList default_parameter_list =
        Teuchos::ParameterList()
            ...
            .set("node_force_field_name", std::string(default_node_force_field_name_),
                 "The field name of the node force within the spherocylinder_segment that we'll sum our potential "
                 "into.");
...
#endif  // MUNDY_LINKERS_LINKER_POTENTIAL_FORCE_REDUCTION_SPHEROCYLINDER_SEGMENT_HPP_
