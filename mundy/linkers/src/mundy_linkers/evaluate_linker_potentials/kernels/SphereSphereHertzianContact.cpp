      ...
      *static_cast<stk::mesh::BulkData *>(bulk_data_ptr_), stk::topology::CONSTRAINT_RANK,
      ...
      [&element_radius_field, &element_youngs_modulus_field, &element_poissons_ratio_field,
       &linker_potential_force_magnitude_field, &linker_signed_separation_distance_field](
        ...
        const double *left_youngs_modulus = stk::mesh::field_data(element_youngs_modulus_field, left_sphere_element);
        const double *right_youngs_modulus = stk::mesh::field_data(element_youngs_modulus_field, right_sphere_element);
        const double *left_poissons_ratio = stk::mesh::field_data(element_poissons_ratio_field, left_sphere_element);
        const double *right_poissons_ratio = stk::mesh::field_data(element_poissons_ratio_field, right_sphere_element);
