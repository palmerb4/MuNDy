  ...
  static std::shared_ptr<mundy::meta::MeshReqs> get_mesh_requirements(
    ...
    for (int i = 0; i < num_linker_parts; i++) {
      ...
      if (part_name == neighbor_linkers::SpherocylinderSpherocylinderLinkers::get_name()) {
        ...
        neighbor_linkers::SpherocylinderSpherocylinderLinkers::add_and_sync_part_reqs(part_reqs);
      } else {
        // Add the associated part as a subset of the spherocylinder spherocylinder linkers agent.
        neighbor_linkers::SpherocylinderSpherocylinderLinkers::add_and_sync_subpart_reqs(part_reqs);
      }
    }
    mesh_reqs_ptr->sync(neighbor_linkers::SpherocylinderSpherocylinderLinkers::get_mesh_requirements());
