...
///
/// \note This class is a constraint rank assembly part containing neighbor linkers between spheres and spherocylinders.
/// It is a subset of the NeighborLinkers agent.
class SphereSpherocylinderLinkers
