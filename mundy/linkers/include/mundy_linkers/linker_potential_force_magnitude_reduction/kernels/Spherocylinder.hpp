...
#ifndef MUNDY_LINKERS_LINKER_POTENTIAL_FORCE_MAGNITUDE_REDUCTION_SPHEROCYLINDER_HPP_
#define MUNDY_LINKERS_LINKER_POTENTIAL_FORCE_MAGNITUDE_REDUCTION_SPHEROCYLINDER_HPP_

/// \file Spherocylinder.hpp
/// \brief Declaration of the LinkerPotentialForceMagnitudeReduction's Spherocylinder kernel.
...
/// that act along the contact normal. Spherocylinder specialization.
class Spherocylinder : public mundy::meta::MetaKernel<> {
 public:
  ...
  static Teuchos::ParameterList get_valid_fixed_params() {
    ...
    default_parameter_list.set(
        "node_torque_field_name", std::string("NODE_TORQUE"),
...
#endif  // MUNDY_LINKERS_LINKER_POTENTIAL_FORCE_MAGNITUDE_REDUCTION_SPHEROCYLINDER_HPP_
