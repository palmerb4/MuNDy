...
#ifndef MUNDY_LINKERS_LINKER_POTENTIAL_FORCE_MAGNITUDE_REDUCTION_SPHEROCYLINDER_SEGMENT_HPP_
#define MUNDY_LINKERS_LINKER_POTENTIAL_FORCE_MAGNITUDE_REDUCTION_SPHEROCYLINDER_SEGMENT_HPP_

/// \file SpherocylinderSegment.hpp
/// \brief Declaration of the LinkerPotentialForceMagnitudeReduction's SpherocylinderSegment kernel.
...
/// that act along the contact normal. SpherocylinderSegment specialization.
class SpherocylinderSegment : public mundy::meta::MetaKernel<> {
 public:
  ...
  static std::shared_ptr<mundy::meta::MeshRequirements> get_mesh_requirements(
    ...
    const int num_spherocylinder_segment_parts = static_cast<int>(valid_entity_part_names.size());
  ...
  static Teuchos::ParameterList get_valid_fixed_params() {
    ...
    default_parameter_list.set("valid_entity_part_names", mundy::core::make_string_array("SPHEROCYLINDER_SEGMENTS"),
    ...
    default_parameter_list.set(
        ...
        "The field name of the node force within the spherocylinder_segment that we'll sum our potential into.");
  ...
  /// \param spherocylinder_segment [in] The spherocylinder_segment acted on by this kernel.
...
#endif  // MUNDY_LINKERS_LINKER_POTENTIAL_FORCE_MAGNITUDE_REDUCTION_SPHEROCYLINDER_SEGMENT_HPP_
