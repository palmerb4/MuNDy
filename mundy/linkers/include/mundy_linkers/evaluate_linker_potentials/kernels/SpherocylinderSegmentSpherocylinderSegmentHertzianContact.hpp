...
#ifndef MUNDY_LINKERS_EVALUATE_LINKER_POTENTIALS_SPHEROCYLINDERSEGMENTSPHEROCYLINDERSEGMENTHERTZIANCONTACT_HPP_
#define MUNDY_LINKERS_EVALUATE_LINKER_POTENTIALS_SPHEROCYLINDERSEGMENTSPHEROCYLINDERSEGMENTHERTZIANCONTACT_HPP_

/// \file SpherocylinderSegmentSpherocylinderSegmentHertzianContact.hpp
/// \brief Declaration of the EvaluateLinkerPotentials's SpherocylinderSegmentSpherocylinderSegmentHertzianContact
/// kernel.
...
/// \class SpherocylinderSegmentSpherocylinderSegmentHertzianContact
...
class SpherocylinderSegmentSpherocylinderSegmentHertzianContact : public mundy::meta::MetaKernel<> {
 public:
  //! \name Typedefs
  //@{
  ...
  /// \brief Constructor
  explicit SpherocylinderSegmentSpherocylinderSegmentHertzianContact(mundy::mesh::BulkData *const bulk_data_ptr,
  ...
  static Teuchos::ParameterList get_valid_fixed_params() {
    ...
    default_parameter_list.set(
        ...
        mundy::core::make_string_array(neighbor_linkers::SpherocylinderSegmentSpherocylinderSegmentLinkers::get_name()),
  ...
  static std::shared_ptr<PolymorphicBaseType> create_new_instance(mundy::mesh::BulkData *const bulk_data_ptr,
                                                                  const Teuchos::ParameterList &fixed_params) {
    return std::make_shared<SpherocylinderSegmentSpherocylinderSegmentHertzianContact>(bulk_data_ptr, fixed_params);
  }
  //@}
...
#endif  // MUNDY_LINKERS_EVALUATE_LINKER_POTENTIALS_SPHEROCYLINDERSEGMENTSPHEROCYLINDERSEGMENTHERTZIANCONTACT_HPP_
