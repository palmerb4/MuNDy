...
#ifndef MUNDY_LINKERS_COMPUTE_SIGNED_SEPARATION_DISTANCE_CONTACT_NORMAL_AND_CONTACT_POINTS_SPHEROCYLINDERSPHEROCYLINDERSEGMENTLINKER_HPP_
#define MUNDY_LINKERS_COMPUTE_SIGNED_SEPARATION_DISTANCE_CONTACT_NORMAL_AND_CONTACT_POINTS_SPHEROCYLINDERSPHEROCYLINDERSEGMENTLINKER_HPP_
...
class SpherocylinderSpherocylinderSegmentLinker : public mundy::meta::MetaKernel<> {
 public:
  ...
  static std::shared_ptr<mundy::meta::MeshRequirements> get_mesh_requirements(
    ...
    // We don't have any requirements for the connected spherocylinders not already specified by the spherocylinder
    // agent
    ...
    // We don't have any requirements for the connected spherocylinders not already specified by the
    // spherocylinder_segments agent
...
#endif  // MUNDY_LINKERS_COMPUTE_SIGNED_SEPARATION_DISTANCE_CONTACT_NORMAL_AND_CONTACT_POINTS_SPHEROCYLINDERSPHEROCYLINDERSEGMENTLINKER_HPP_
