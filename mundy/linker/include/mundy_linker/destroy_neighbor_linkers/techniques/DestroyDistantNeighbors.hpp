...
#ifndef MUNDY_LINKER_DESTROY_NEIGHBOR_LINKERS_TECHNIQUES_DESTROYDISTANTNEIGHBORS_HPP_
#define MUNDY_LINKER_DESTROY_NEIGHBOR_LINKERS_TECHNIQUES_DESTROYDISTANTNEIGHBORS_HPP_
  ...
  static std::shared_ptr<mundy::meta::MeshRequirements> get_mesh_requirements(
    ...
    for (int i = 0; i < valid_linker_entity_part_names.size(); i++) {
      ...
      if (part_name == "NEIGHBOR_LINKERS") {
        // Add the requirements directly to neighbor linkers part.
        mundy::agent::AgentHierarchy::add_part_reqs(part_reqs, "NEIGHBOR_LINKERS", "LINKERS");
        mesh_reqs_ptr->merge(mundy::agent::AgentHierarchy::get_mesh_requirements("NEIGHBOR_LINKERS", "LINKERS"));
      } else {
        // Add the requirements as a subpart of the neighbor linkers part.
...
#endif  // MUNDY_LINKER_DESTROY_NEIGHBOR_LINKERS_TECHNIQUES_DESTROYDISTANTNEIGHBORS_HPP_
