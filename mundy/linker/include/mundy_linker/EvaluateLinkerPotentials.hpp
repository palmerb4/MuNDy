...
#ifndef MUNDY_LINKER_EVALUATELINKERPOTENTIALS_HPP_
#define MUNDY_LINKER_EVALUATELINKERPOTENTIALS_HPP_
...
MUNDY_REGISTER_METACLASS("SPHERE_SPHERE_HERTZIAN_CONTACT",
                         mundy::linker::evaluate_linker_potentials::kernels::SphereSphereHertzianContact,
                         mundy::linker::EvaluateLinkerPotentials::OurKernelFactory)
//@}

#endif  // MUNDY_LINKER_EVALUATELINKERPOTENTIALS_HPP_
