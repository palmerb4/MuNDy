...
#ifndef MUNDY_LINKER_LINKERPOTENTIALFORCEMAGNITUDEREDUCTION_HPP_
#define MUNDY_LINKER_LINKERPOTENTIALFORCEMAGNITUDEREDUCTION_HPP_
...
#include <mundy_linker/linker_potential_force_magnitude_reduction/kernels/Sphere.hpp>  // for mundy::linker::...::kernels::SphereSphereHertzianContact
...
MUNDY_REGISTER_METACLASS("SPHERE", mundy::linker::linker_potential_force_magnitude_reduction::kernels::Sphere,
                         mundy::linker::LinkerPotentialForceMagnitudeReduction::OurKernelFactory)
//@}

#endif  // MUNDY_LINKER_LINKERPOTENTIALFORCEMAGNITUDEREDUCTION_HPP_
