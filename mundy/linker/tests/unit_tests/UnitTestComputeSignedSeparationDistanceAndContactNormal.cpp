...
TEST(ComputeSignedSeparationDistanceAndContactNormal, PerformsOBBCalculationCorrectlyForSphere) {
  ...
  */
  ...
  mundy::linker::declare_constraint_relations_to_family_tree_with_sharing(bulk_data_ptr.get(), linker_constraint,
