...
class ExampleNameData : public ExampleNameDataBase {
 ...
 public:
  ...
  ExampleNameData(const std::string& name, const stk::mesh::BulkData& bulk_data, const stk::mesh::PartVector& parts,
    ...
    assert_correct_rank_for_input_data_placeholder;
  }
...
auto create_example_name_data(const stk::mesh::BulkData& bulk_data, const stk::mesh::PartVector& parts,
...
/// See the discussion for create_example_name_data for more information. Only difference is NgpFields over Fields.
template <typename Scalar,                           // Must be provided
          stk::topology::topology_t OurTopology,     // Must be provided
          list_of_templated_data_types_placeholder>  // deduced
auto create_ngp_example_name_data(const stk::mesh::NgpMesh& ngp_mesh, list_of_type_deduced_data_placeholder) {
