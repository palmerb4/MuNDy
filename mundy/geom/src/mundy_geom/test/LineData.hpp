...
if constexpr (std::is_same_v<DirectionDataTag, tag_type::FIELD>) {
...
} else if constexpr (std::is_same_v<DirectionDataTag, tag_type::VECTOR_OF_FIELDS>) {
...
static constexpr DirectionDataTag direction_data_tag() {
