...
class Spherocylinder {
  static_assert(std::is_same_v<typename PointType::scalar_t, Scalar> && std::is_same_v<typename QuaternionType::scalar_t, Scalar>,
                "The scalar type of the PointType and QuaternionType must match the scalar type of the Spherocylinder.");
  static_assert(std::is_same_v<typename PointType::ownership_t, OwnershipType> && std::is_same_v<typename QuaternionType::ownership_t, OwnershipType>,
 ...
 public:
  ...
  /// \brief Default constructor for owning Spherocylinders. Default initializes the center and sets the radius to an invalid
  /// value of -1
  KOKKOS_FUNCTION
  Spherocylinder()
  ...
  KOKKOS_FUNCTION
  Spherocylinder(const point_t& center, 
  const orientation_t& orientation, const scalar_t& radius)
  ...
  KOKKOS_FUNCTION Spherocylinder(const OtherPointType& center, const OtherQuaternionType& orientation, const scalar_t& radius)
  ...
  KOKKOS_FUNCTION
  Spherocylinder(const Spherocylinder<scalar_t, point_t, orientation_t, ownership_t>& other) : center_(other.center_),
  orientation_(other.orientation_), radius_(other.radius_) {
  }
  ...
  Spherocylinder(Spherocylinder<scalar_t, point_t, orientation_t, ownership_t>&& other)
      : center_(std::move(other.center_)), orientation_{std::move(other.orientation_)}, radius_(std::move(other.radius_)) {
  }
  ...
  KOKKOS_FUNCTION
  Spherocylinder<scalar_t, point_t, orientation_t, ownership_t>& operator=(const Spherocylinder<scalar_t, point_t, orientation_t, ownership_t>& other) {
  ...
  /// \brief Copy assignment operator
  template <typename OtherSpherocylinderType>
  KOKKOS_FUNCTION Spherocylinder<scalar_t, point_t, orientation_t, ownership_t>& operator=(const OtherSpherocylinderType& other)
    requires(!std::is_same_v<OtherSpherocylinderType, Spherocylinder<scalar_t, point_t, orientation_t, ownership_t>>)
  {
    MUNDY_THROW_ASSERT(this != &other, std::invalid_argument, "Cannot assign to self");
    center_ = other.center_;
  ...
  KOKKOS_FUNCTION
  Spherocylinder<scalar_t, point_t, orientation_t, ownership_t>& operator=(Spherocylinder<scalar_t, point_t, orientation_t, ownership_t>&& other) {
    MUNDY_THROW_ASSERT(this != &other, std::invalid_argument, "Cannot assign to self");
  ...
  /// \brief Move assignment operator
  template <typename OtherSpherocylinderType>
  KOKKOS_FUNCTION Spherocylinder<scalar_t, point_t, orientation_t, ownership_t>& operator=(OtherSpherocylinderType&& other)
    requires(!std::is_same_v<OtherSpherocylinderType, Spherocylinder<scalar_t, point_t, orientation_t, ownership_t>>)
  {
    MUNDY_THROW_ASSERT(this != &other, std::invalid_argument, "Cannot assign to self");
    center_ = std::move(other.center_);
...
//
template <typename Scalar, ValidPointType PointType, mundy::math::ValidQuaternionType QuaternionType, typename OwnershipType>
...
concept ValidSpherocylinderType = requires(std::decay_t<SpherocylinderType> spherocylinder, const std::decay_t<SpherocylinderType> const_spherocylinder) {
...
static_assert(ValidSpherocylinderType<Spherocylinder<float>> && ValidSpherocylinderType<const Spherocylinder<float>> &&
                  ValidSpherocylinderType<Spherocylinder<double>> && ValidSpherocylinderType<const Spherocylinder<double>>,
...
KOKKOS_FUNCTION bool operator==(const SpherocylinderType1& spherocylinder1, const SpherocylinderType2& spherocylinder2) {
  return (spherocylinder1.radius() == spherocylinder2.radius()) && (spherocylinder1.center() == spherocylinder2.center())
