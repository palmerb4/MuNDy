...
// All of our headers for aggregates of primitive geometric objects
//
...
// when using complex aggregates with many fields and is a key benefit of the data oriented design pattern. While out
