...
class ExampleNameData : public ExampleNameDataBase {
 ...
 public:
  ...
  using example_data1_t = map_tag_to_data_type_t</* Tag */ ExampleData1Tag,  //
                                                 /* Scalar */ scalar_t,      //
                                                 /* Shared type */ ExampleData1SharedType>;
  using example_data2_t = map_tag_to_data_type_t</* Tag */ ExampleData2Tag,  //
                                                 /* Scalar */ scalar_t,      //
                                                 /* Shared type */ ExampleData2SharedType>;
  ...
  auto get_updated_ngp_data() const {
    return create_ngp_ellipsoid_data<scalar_t, OurTopology>(
        ...
        tagged_data_to_ngp<ExampleData1Tag, scalar_t, mundy::math::Vector3<scalar_t>>(example_data1_),
