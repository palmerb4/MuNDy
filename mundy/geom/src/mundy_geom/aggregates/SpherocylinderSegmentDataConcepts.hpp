...
#ifndef MUNDY_GEOM_AGGREGATES_SPHEROCYLINDERSEGMENTDATACONCEPTS_HPP_
#define MUNDY_GEOM_AGGREGATES_SPHEROCYLINDERSEGMENTDATACONCEPTS_HPP_
...
struct spherocylinder_segment_tag {
  static constexpr unsigned value = 2978913391;
};
//
constexpr spherocylinder_segment_tag_v = spherocylinder_segment_tag::value;

/// @brief The inverse map from tag value to tag type 
template <>
struct value_to_tag_type<2978913391> {
    using type = spherocylinder_segment_tag;
};
...
#endif  // MUNDY_GEOM_AGGREGATES_SPHEROCYLINDERSEGMENTDATACONCEPTS_HPP_