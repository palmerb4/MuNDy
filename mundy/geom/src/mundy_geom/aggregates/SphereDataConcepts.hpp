...
#ifndef MUNDY_GEOM_AGGREGATES_SPHEREDATACONCEPTS_HPP_
#define MUNDY_GEOM_AGGREGATES_SPHEREDATACONCEPTS_HPP_
...
struct sphere_tag {
  static constexpr unsigned value = 1702294160;
};
//
constexpr sphere_tag_v = sphere_tag::value;

/// @brief The inverse map from tag value to tag type 
template <>
struct value_to_tag_type<1702294160> {
...
#endif  // MUNDY_GEOM_AGGREGATES_SPHEREDATACONCEPTS_HPP_