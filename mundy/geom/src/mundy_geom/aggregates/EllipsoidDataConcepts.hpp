...
#ifndef MUNDY_GEOM_AGGREGATES_ELLIPSOIDDATACONCEPTS_HPP_
#define MUNDY_GEOM_AGGREGATES_ELLIPSOIDDATACONCEPTS_HPP_
...
#endif  // MUNDY_GEOM_AGGREGATES_ELLIPSOIDDATACONCEPTS_HPP_