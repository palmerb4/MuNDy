...
# bash ../do-cmake-release.sh /mnt/sw/nix/store/ajfmwdjwipp5rrpkq8dj4aff23ar4cix-trilinos-14.2.0 ~/local/lib/mundy_libs ../
...
-DCMAKE_INSTALL_PREFIX=${INSTALL_DIR:-$HOME/local/lib/mundy_libs} \
-DTPL_ENABLE_MPI=ON \
