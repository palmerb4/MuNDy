...
#ifndef MUNDY_METHODS_RESOLVE_CONSTRAINTS_TECHNIQUES_COMPUTECONSTRAINTRESIDUAL_HPP_
#define MUNDY_METHODS_RESOLVE_CONSTRAINTS_TECHNIQUES_COMPUTECONSTRAINTRESIDUAL_HPP_
...
class ComputeConstraintResidual : public mundy::meta::MetaMethod<double, ComputeConstraintResidual>,
 ...
 public:
  ...
  /// \brief Constructor
  ComputeConstraintResidual(stk::mesh::BulkData *const bulk_data_ptr, const Teuchos::ParameterList &parameter_list);
  //@}
  ...
  static std::shared_ptr<mundy::meta::MetaMethodBase<double>> details_static_create_new_instance(
    ...
    return std::make_shared<ComputeConstraintResidual>(bulk_data_ptr, parameter_list);
  }
  //@}
...
#endif  // MUNDY_METHODS_RESOLVE_CONSTRAINTS_TECHNIQUES_COMPUTECONSTRAINTRESIDUAL_HPP_
