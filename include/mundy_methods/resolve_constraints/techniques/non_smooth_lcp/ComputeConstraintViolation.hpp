...
#ifndef MUNDY_METHODS_RESOLVE_CONSTRAINTS_TECHNIQUES_COMPUTECONSTRAINTVIOLATION_HPP_
#define MUNDY_METHODS_RESOLVE_CONSTRAINTS_TECHNIQUES_COMPUTECONSTRAINTVIOLATION_HPP_
...
class ComputeConstraintViolation : public mundy::meta::MetaMethod<void, ComputeConstraintViolation>,
                                   public mundy::meta::MetaMethodRegistry<void, ComputeConstraintViolation> {
 public:
  ...
  /// \brief Constructor
  ComputeConstraintViolation(stk::mesh::BulkData *const bulk_data_ptr, const Teuchos::ParameterList &parameter_list);
  //@}
...
#endif  // MUNDY_METHODS_RESOLVE_CONSTRAINTS_TECHNIQUES_COMPUTECONSTRAINTVIOLATION_HPP_
