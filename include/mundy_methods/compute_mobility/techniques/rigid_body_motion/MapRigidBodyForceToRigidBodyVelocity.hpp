...
#ifndef MUNDY_METHODS_COMPUTE_MOBILITY_TECHNIQUES_RIGID_BODY_MOTION_MAPRIGIDBODYFORCETORIGIDBODYVELOCITY_HPP_
#define MUNDY_METHODS_COMPUTE_MOBILITY_TECHNIQUES_RIGID_BODY_MOTION_MAPRIGIDBODYFORCETORIGIDBODYVELOCITY_HPP_
...
class MapRigidBodyForceToRigidBodyVelocity
 ...
 public:
  ...
  static std::shared_ptr<mundy::meta::MetaMethodBase<void>> details_static_create_new_instance(
    ...
    return std::make_shared<MapRigidBodyForceToRigidBodyVelocity>(bulk_data_ptr, parameter_list);
  }
  //@}
