...
class RigidBodyMotion : public mundy::meta::MetaMethod<void, RigidBodyMotion>,
                        public mundy::meta::MetaMethodRegistry<void, RigidBodyMotion> {
 public:
  ...
  /// \brief Constructor
  RigidBodyMotion(stk::mesh::BulkData *const bulk_data_ptr, const Teuchos::ParameterList &parameter_list);
  //@}
  ...
  static Teuchos::ParameterList details_static_get_valid_params() {
    ...
    Teuchos::ParameterList &method_params =
        default_parameter_list.sublist("methods", false, "Sublist that defines the sub-methods and their parameters.");
  ...
  static std::shared_ptr<mundy::meta::MetaMethodBase<void>> details_static_create_new_instance(
    ...
    return std::make_shared<RigidBodyMotion>(bulk_data_ptr, parameter_list);
  }
  //@}
