...
#ifndef MUNDY_METHODS_DeleteCollisionConstraints_HPP_
#define MUNDY_METHODS_DeleteCollisionConstraints_HPP_
...
class DeleteCollisionConstraints : public mundy::meta::MetaMethod<void> {
 public:
  //! \name Typedefs
  //@{
