...
#include <mundy_methods/compute_mobility/techniques/rigid_body_motion/map_rigid_body_velocity_to_surface_velocity/kernels/AllKernels.hpp>  // performs the registration of all kernels
