...
#ifndef MUNDY_METHODS_DETECTNEIGHBORSAABB_HPP_
#define MUNDY_METHODS_DETECTNEIGHBORSAABB_HPP_

/// \file DetectNeighborsAABB.hpp
/// \brief Declaration of the DetectNeighborsAABB class
...
#endif  // MUNDY_METHODS_DETECTNEIGHBORSAABB_HPP_
