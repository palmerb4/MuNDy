...
#ifndef MUNDY_METHODS_REFINENEIGHBORSOBB_HPP_
#define MUNDY_METHODS_REFINENEIGHBORSOBB_HPP_

/// \file RefineNeighborsOBB.hpp
/// \brief Declaration of the RefineNeighborsOBB class
...
#endif  // MUNDY_METHODS_REFINENEIGHBORSOBB_HPP_
