...
#ifndef MUNDY_METHODS_OBBMANAGER_HPP_
#define MUNDY_METHODS_OBBMANAGER_HPP_

/// \file OBBManager.hpp
/// \brief Declaration of the OBBManager class
...
/// \class OBBManager
/// \brief Uniform interface for all concete OBBManager objects.
class OBBManager {
...
#endif  // MUNDY_METHODS_OBBMANAGER_HPP_
