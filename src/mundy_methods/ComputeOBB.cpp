...
/// \file ComputeOBB.hpp
/// \brief Definition of the ComputeOBB class
...
ComputeOBB::ComputeOBB(mundy::mesh::BulkData *const bulk_data_ptr, const Teuchos::ParameterList &fixed_parameter_list)
  ...
  for (size_t i = 0; i < num_parts_; i++) {
    ...
    compute_obb_kernel_ptrs_.push_back(mundy::meta::MetaKernelFactory<void, ComputeOBB>::create_new_instance(
...
Teuchos::ParameterList ComputeOBB::set_mutable_params(const Teuchos::ParameterList &mutable_parameter_list) const {
  ...
  for (size_t i = 0; i < num_parts_; i++) {
    ...
    stk::mesh::for_each_entity_run(
        *bulk_data_ptr_, stk::topology::ELEM_RANK, locally_owned_part,
        [&compute_obb_kernel_ptr]([[maybe_unused]] const mundy::mesh::BulkData &bulk_data, stk::mesh::Entity element) {
