...
#ifndef MUNDY_METHODS_TIMEINTEGRATION_HPP_
#define MUNDY_METHODS_TIMEINTEGRATION_HPP_

/// \file TimeIntegration.hpp
/// \brief Declaration of the TimeIntegration class
...
class TimeIntegration : MetaMethod {
 public:
  ...
  ///
  TimeIntegration(const std::shared_ptr<stk::mesh::BulkData> &bulk_data_ptr,
...
TimeIntegration<GroupTopology, Scalar>::TimeIntegration(const std::shared_ptr<stk::mesh::BulkData> &bulk_data_ptr,
                                                const stk::util::ParameterList &parameter_list) {
...
TimeIntegration<GroupTopology, Scalar>::get_multibody_part_requirements() const {
  return group_part_;
}
//}
//@}
...
#endif  // MUNDY_METHODS_TIMEINTEGRATION_HPP_
