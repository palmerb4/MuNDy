...
class ResolveConstraints : MetaMethod {
 public:
  ...
  ///
  ResolveConstraints(const std::shared_ptr<stk::mesh::BulkData> &bulk_data_ptr,
...
ResolveConstraints<GroupTopology, Scalar>::ResolveConstraints(const std::shared_ptr<stk::mesh::BulkData> &bulk_data_ptr,
                                                const stk::util::ParameterList &parameter_list) {
...
ResolveConstraints<GroupTopology, Scalar>::get_multibody_part_requirements() const {
  return group_part_;
}
//}
//@}
