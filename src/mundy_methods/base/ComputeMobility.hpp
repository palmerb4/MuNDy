...
class ComputeMobility : MetaMethod {
 public:
  ...
  ///
  ComputeMobility(const std::shared_ptr<stk::mesh::BulkData> &bulk_data_ptr,
...
ComputeMobility<GroupTopology, Scalar>::ComputeMobility(const std::shared_ptr<stk::mesh::BulkData> &bulk_data_ptr,
                                                const stk::util::ParameterList &parameter_list) {
...
ComputeMobility<GroupTopology, Scalar>::get_multibody_part_requirements() const {
  return group_part_;
}
//}
//@}
