...
#ifndef MUNDY_METHODS_REFINENEIGHBORS_HPP_
#define MUNDY_METHODS_REFINENEIGHBORS_HPP_

/// \file RefineNeighbors.hpp
/// \brief Declaration of the RefineNeighbors class
...
class RefineNeighbors : MetaMethod {
 public:
  ...
  ///
  RefineNeighbors(const std::shared_ptr<stk::mesh::BulkData> &bulk_data_ptr,
...
RefineNeighbors<GroupTopology, Scalar>::RefineNeighbors(const std::shared_ptr<stk::mesh::BulkData> &bulk_data_ptr,
                                                const stk::util::ParameterList &parameter_list) {
...
RefineNeighbors<GroupTopology, Scalar>::get_multibody_part_requirements() const {
  return group_part_;
}
//}
//@}
...
#endif  // MUNDY_METHODS_REFINENEIGHBORS_HPP_
