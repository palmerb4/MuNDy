...
class GenerateCollisionConstraints : MetaMethod {
 public:
  ...
  ///
  GenerateCollisionConstraints(const std::shared_ptr<stk::mesh::BulkData> &bulk_data_ptr,
...
GenerateCollisionConstraints<GroupTopology, Scalar>::GenerateCollisionConstraints(const std::shared_ptr<stk::mesh::BulkData> &bulk_data_ptr,
                                                const stk::util::ParameterList &parameter_list) {
...
GenerateCollisionConstraints<GroupTopology, Scalar>::get_multibody_part_requirements() const {
  return group_part_;
}
//}
//@}
