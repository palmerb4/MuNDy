...
#ifndef MUNDY_METHODS_DETECTNEIGHBORS_HPP_
#define MUNDY_METHODS_DETECTNEIGHBORS_HPP_

/// \file DetectNeighbors.hpp
/// \brief Declaration of the DetectNeighbors class
...
class DetectNeighbors : MetaMethod {
 public:
  ...
  ///
  DetectNeighbors(const std::shared_ptr<stk::mesh::BulkData> &bulk_data_ptr,
...
DetectNeighbors<GroupTopology, Scalar>::DetectNeighbors(const std::shared_ptr<stk::mesh::BulkData> &bulk_data_ptr,
                                                const stk::util::ParameterList &parameter_list) {
...
DetectNeighbors<GroupTopology, Scalar>::get_multibody_part_requirements() const {
  return group_part_;
}
//}
//@}
...
#endif  // MUNDY_METHODS_DETECTNEIGHBORS_HPP_
