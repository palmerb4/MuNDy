...
#include <mundy_motion/compute_mobility/techniques/rigid_body_motion/map_rigid_body_force_to_rigid_body_velocity/techniques/AllTechniques.hpp>  // performs the registration of all techniques
